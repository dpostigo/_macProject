...
+ (NSBezierPath *) bezierPathWithRect: (NSRect) rect pathOptions: (PathOptions *) pathOptions {
    ...
    NSBezierPath *path;
    if (pathOptions.cornerRadius == 0.0 || (pathOptions.cornerType & CornerNone)) {
        path = [NSBezierPath bezierPathWithRect: rect];
    } else {
        path = [NSBezierPath bezierPathWithRect: rect cornerRadius: pathOptions.cornerRadius cornerType: pathOptions.cornerType];
        //        path = [NSBezierPath bezierPathWithRoundedRect: rect corners: [pathOptions.cornerProperties jsOptions] radius: pathOptions.cornerRadius];
    }
...
+ (void) drawBezierPathWithRect: (NSRect) rect options: (PathOptions *) pathOptions {
    ...
    for (BorderOption *borderOption in pathOptions.borders) {
