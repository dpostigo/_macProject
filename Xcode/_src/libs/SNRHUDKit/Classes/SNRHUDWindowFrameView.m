...
- (NSShadow *) windowShadow {
    if (windowShadow == nil) {
        windowShadow = [NSShadow new];
        [windowShadow setShadowColor: SNRWindowTitleShadowColor];
        [windowShadow setShadowOffset: SNRWindowTitleShadowOffset];
        [windowShadow setShadowBlurRadius: SNRWindowTitleShadowBlurRadius];
    }
    return windowShadow;
}
