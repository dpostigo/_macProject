...
- (void) setup {
    ...
    //
    //    pathOptions.gradient = [[NSGradient alloc] initWithColorsAndLocations: [NSColor colorWithWhite: 0.8], 0.0,
    //                                                                           [NSColor colorWithWhite: 0.9], 0.05,
    //                                                                           [NSColor colorWithWhite: 0.9], 0.95,
    //                                                                           [NSColor colorWithWhite: 0.8], 1.0,
    //                                                                           nil];
