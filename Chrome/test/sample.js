...
//   var title = "TestCarts '" + context + "' menu item";
...
var parent = chrome.contextMenus.create({"title": "Save To Carts", "onclick": handleClick});
...
var radio1 = chrome.contextMenus.create({"title": "Radio 1", "type": "page", "onclick":radioOnClick});
...
var checkbox1 = chrome.contextMenus.create( {"title": "Checkbox1", "contexts": ["page"], "onclick":checkboxOnClick});
