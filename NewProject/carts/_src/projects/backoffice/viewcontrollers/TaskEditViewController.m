...
- (void) prepareDataSource {
    ...
    //    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Task" detailTextLabel: task.title cellIdentifier: @"TaskCell"]];
    //    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Service Item" detailTextLabel: task.serviceItem.title cellIdentifier: @"TokenCell"]];
    //    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Job" detailTextLabel: task.job.title cellIdentifier: @"TokenCell"]];
    //    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Notes" detailTextLabel: task.notes cellIdentifier: @"NotesCell"]];
    //    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Start Date" detailTextLabel: [_model.slugFormatter stringFromDate: task.startDate] cellIdentifier: @"DateCell"]];
    //    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Due Date" detailTextLabel: [_model.slugFormatter stringFromDate: task.dueDate] cellIdentifier: @"DateCell"]];
    //    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Assignee" detailTextLabel: task.assignee.title cellIdentifier: @"TokenCell"]];
    //    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Observers" cellIdentifier: @"TokenCell" content: task.observerIds]];
    ...
    tableSection = [[DataSection alloc] initWithTitle: @""];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Task" detailTextLabel: task.title cellIdentifier: @"TaskCell"]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Service Item" detailTextLabel: task.serviceItem.title cellIdentifier: @"TokenCell" content: _model.serviceItems image: [NSImage imageNamed: @"service-item-icon"]]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Job" detailTextLabel: task.job.title cellIdentifier: @"TokenCell" content: _model.jobs image: [NSImage imageNamed: @"job-icon-dark"]]];
    ...
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Start Date" detailTextLabel: [_model.slugFormatter stringFromDate: task.startDate] cellIdentifier: @"DateCell" image: [NSImage imageNamed: @"today-icon-dark"]]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Due Date" detailTextLabel: [_model.slugFormatter stringFromDate: task.startDate] cellIdentifier: @"DateCell" image: [NSImage imageNamed: @"due-icon-dark"]]];
