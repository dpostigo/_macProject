...
- (void) prepareDataSource {
    ...
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Task" cellIdentifier: @"TaskCell"]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Service Item" cellIdentifier: @"TokenCell" content: _model.serviceItems image: [NSImage imageNamed: @"service-item-icon"]]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Job" cellIdentifier: @"TokenCell" content: _model.jobs image: [NSImage imageNamed: @"job-icon-dark"]]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Notes" image: [NSImage imageNamed: @"notes-icon"] cellIdentifier: @"NotesCell"]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Start Date" image: [NSImage imageNamed: @"today-icon-dark"] cellIdentifier: @"DateCell"]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Due Date" image: [NSImage imageNamed: @"due-icon-dark"] cellIdentifier: @"DateCell"]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Assignee" image: [NSImage imageNamed: @"assignee-icon"] cellIdentifier: @"TokenCell"]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Observers" cellIdentifier: @"TokenCell" content: _model.contacts image: [NSImage imageNamed: @"observers-icon"]]];
...
- (NSArray *) tokenField: (NSTokenField *) tokenField completionsForSubstring: (NSString *) substring indexOfToken: (NSInteger) tokenIndex indexOfSelectedItem: (NSInteger *) selectedIndex {
    ...
    if ([tokenField isKindOfClass: [BasicTokenField class]]) {
        BasicTokenField *basicTokenField = (BasicTokenField *) tokenField;
        DataItemObject *rowObject = basicTokenField.rowObject;
...
//
//- (NSArray *) tokenField: (BasicTokenField *) tokenField completionsForString: (NSString *) substring rowObject: (DataItemObject *) rowObject {
//
//    NSArray *ret = [NSArray array];
//    NSArray *array;
//
