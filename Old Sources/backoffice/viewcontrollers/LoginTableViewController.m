...
- (void) prepareDataSource {
    ...
    DataSection *tableSection = [[DataSection alloc] initWithTitle: @"Section"];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"HeaderCell" cellIdentifier: @"HeaderCell"]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Username" cellIdentifier: @"TextFieldCell"]];
    [tableSection.rows addObject: [[DataItemObject alloc] initWithTextLabel: @"Password" cellIdentifier: @"PasswordCell"]];
